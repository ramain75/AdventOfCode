...
public class TwentySixteenDay4Test {

    @Test
    void testIsRealRoomValid1() {
        String input = "aaaaa-bbb-z-y-x-123[abxyz]";

        assertEquals(123, TwentySixteenDay4.isRealRoom(input), "Should be a real room");
    }

    @Test
    void testIsRealRoomValid2() {
        String input = "a-b-c-d-e-f-g-h-987[abcde]";

        assertEquals(987, TwentySixteenDay4.isRealRoom(input), "Should be a real room");
    }

    @Test
    void testIsRealRoomValid3() {
        String input = "not-a-real-room-404[oarel]";

        assertEquals(404, TwentySixteenDay4.isRealRoom(input), "Should be a real room");
    }

    @Test
    void testIsRealRoomInvalid() {
        String input = "totally-real-room-200[decoy]";

        assertEquals(0, TwentySixteenDay4.isRealRoom(input), "Should not be a real room");
    }

    /**
     * Testing that we can handle an exception in the method and/or don't get stuck in a loop,
     * and that the comparison at the end doesn't throw another exception.
     */
    @Test
    void testIsRealRoomCalculatedChecksumShorterThan5() {
        String input = "total-200[decoy]";

        assertEquals(0, TwentySixteenDay4.isRealRoom(input), "Should not be a real room");
    }

    @Test
    void testSumSectorIDsForRealRoomsUsingSampleInput() {
        String input = """
        ...
        assertEquals(1514, TwentySixteenDay4.sumSectorIDsForRealRooms(input), "Sum of sector IDs for real rooms is not as expected");
    }

    @Test
    void testSumSectorIDsForRealRoomsUsingRealInput() {
        assertEquals(158835, TwentySixteenDay4.sumSectorIDsForRealRooms(realInput), "Sum of sector IDs for real rooms is not as expected");
    }
    
    @Test
    void testDecryptValidRoomUsingShiftCipherSampleInput() {
        String input = "qzmt-zixmtkozy-ivhz-343";
        assertEquals("very encrypted name", TwentySixteenDay4.decryptValidRoomUsingShiftCipher(input), "Decrypted room name is invalid");
    }

    @Test
    void testFindSectorIDMatching() {
        assertEquals( 993, TwentySixteenDay4.findSectorIDMatching(realInput, "northpole object storage"), "North Pole objects room not found");
    }

    private final static String realInput = """
